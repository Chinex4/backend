...
class EmailTemplate
{
  ...
  public function buildOtpForLoginHtml(string $fullname, string $otpCode, $emailLogo, $supportMail): string
  {
    return '
        <!DOCTYPE html>
        <html lang="en">
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #1e1e1e; border-radius: 12px; width: 100%; max-width: 600px;">
                  ...
                  <tr>
                    <td align="center" style="padding: 30px 20px; text-align: center;">
                      <h1 style="color: #ffffff; font-size: 28px; margin-bottom: 20px;">Login Verification</h1>
                      <p style="font-size: 16px; color: #cccccc; line-height: 1.6; margin: 0;">
                        Dear ' . htmlspecialchars($fullname) . ',<br><br>
                        Please use the code below to verify your login attempt.
                      </p>
                      ...
                      <p style="font-size: 14px; color: #999999; margin: 20px 0;">
                        This code is valid for 1 hour and can only be used once.<br>
                        If this login attempt was not initiated by you, please contact us immediately at
  ...
  public function buildOtpForChangePasswordHtml(string $fullname, string $otpCode, $emailLogo, $supportMail): string
{
    return '
        <!DOCTYPE html>
        <html lang="en">
            ...
            <tr>
              <td align="center" style="padding: 20px;">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #1e1e1e; border-radius: 12px; width: 100%; max-width: 600px;">
                  ...
                  <tr>
                    <td align="center" style="padding: 30px 20px; text-align: center;">
                      <h1 style="color: #ffffff; font-size: 28px; margin-bottom: 20px;">Verify Your Request</h1>
                      <p style="font-size: 16px; color: #cccccc; line-height: 1.6; margin: 0;">
                        Dear ' . htmlspecialchars($fullname) . ',<br><br>
                        Use the code below to verify your identity and proceed with changing your password.
                      </p>
                      <div style="font-size: 36px; font-weight: bold; color: #e5f455; margin: 30px 0;">
                        ' . htmlspecialchars($otpCode) . '
                      </div>
                      <p style="font-size: 14px; color: #999999; margin: 20px 0;">
                        This code will expire in 10 minutes. Do not share it with anyone.<br>
                        Need help? Contact us at <a href="mailto:' . $supportMail . '" style="color: #e5f455;">' . $supportMail . '</a>.
                      </p>
                    </td>
                  </tr>
  ...
  public function buildGoogleAuthEmailOtpHtml(string $fullname, string $otpCode, string $emailLogo, string $supportMail): string
{
    return '
    <!DOCTYPE html>
    <html lang="en">
        ...
        <tr>
          <td align="center" style="padding: 20px;">
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #1e1e1e; border-radius: 12px; width: 100%; max-width: 600px;">
              ...
              <tr>
                <td align="center" style="padding: 30px 20px; text-align: center;">
                  <h1 style="color: #ffffff; font-size: 26px; margin-bottom: 20px;">Verify Your Email Address</h1>
                  <p style="font-size: 16px; color: #cccccc; line-height: 1.6; margin: 0;">
                    Dear ' . htmlspecialchars($fullname) . ',<br><br>
                    Please use the verification code below to confirm your email address and complete the setup for Google Authenticator.
                  </p>
                  <div style="margin: 30px auto; display: inline-block; background: #2a2a2a; padding: 16px 32px; border-radius: 8px;">
                    <span style="font-size: 24px; letter-spacing: 4px; font-weight: bold; color: #e5f455;">' . htmlspecialchars($otpCode) . '</span>
                  </div>
                  <p style="font-size: 14px; color: #999999; margin: 30px 0;">
